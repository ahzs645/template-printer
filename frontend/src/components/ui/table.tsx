...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-t border-line-subtle bg-surface-alt font-medium [&>tr]:last:border-b-0',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-line-subtle transition-colors hover:bg-hover data-[state=selected]:bg-accent-soft',
      className
    )}
    {...props}
  />

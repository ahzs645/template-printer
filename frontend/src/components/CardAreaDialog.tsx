        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            <label
              style={{
                ...
                border: `1px solid ${selectedId === WHOLE_CANVAS ? 'var(--text-primary)' : 'var(--border-default)'}`,
                borderRadius: '0.5rem',
            ...
            {candidates.map((candidate) => (
              <label
                ...
                style={{
                  ...
                  gap: '0.625rem',
                  alignItems: 'flex-start',
                  border: `1px solid ${selectedId === candidate.id ? 'var(--text-primary)' : 'var(--border-default)'}`,
                  borderRadius: '0.5rem',
                  padding: '0.625rem 0.75rem',
                  cursor: 'pointer',
                }}
          ...
          {selected && (
            <>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
                ...
                {format.note && (
                  <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', margin: 0 }}>{format.note}</p>
                )}
              </div>
          ...
          >
            ...
            {applied ? (
              ...
              <div style={{ color: 'var(--text-muted)' }}>Pick a rectangle to see the printed size.</div>
            )}
            {applied?.trimLineRemoved && (
              <div style={{ color: 'var(--text-muted)' }}>The trim line is taken out, so it will not print.</div>
            )}
            <div style={{ color: 'var(--text-muted)' }}>
